function[M]=bmcc_asymmetric_splitting_3_vectorised_large_scale(d)
%%% Asymmetric Operator Splitting for 3 Pool classical CEST, large scale
% See
...
for n=1:d.Nu-1 % time loop
    ...
    K3=repmat((-w+wref*d.dw(3))*d.dt,1,1)';
